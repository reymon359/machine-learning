...
regressor = DecisionTreeRegressor(random_state = 0) # Creating the regressor object
regressor.fit(X, y) # Fitting it

# Predicting a new result 
y_pred = regressor.predict([[6.5]])  

# Visualizing the Decision Tree Regression results (for higher resolution and smooother curve)
